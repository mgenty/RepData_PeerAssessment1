...
**There were `r naDays` days out of `r totalDays` that had NA step values.**
**For any given day, there are `r intsPerDay` intervals recorded, and for**
**the `r naDays` days in question all of the step counts were NAs, for a**
**total of `r totalNAs` out of `r totalRows` observations (~`r naPercent`%).** 
...
**on the `r naDays` days in question.**    
